package net.petercashel.RealmsOfAvalonMod.Container;
...
public class ContainerBasic extends Container {
    ...
    private TileEntityBase_Container te;

    public ContainerBasic(InventoryPlayer playerInventory, TileEntityBase_Container tileEntityBase_container) {
        te = tileEntityBase_container;
        addOwnSlots();
